...
def get_model_type(agent_type: str = "sub_agent") -> str:
    ...
    Returns:
        str: The model type to use for the specified agent type.
             - Main agent uses MODEL_TYPE_MAIN (defaults to "gemini-2.0-flash-exp" for live)
    ...
    if agent_type == "main":
        ...
        return os.getenv("MODEL_TYPE_SUB", "gemini-2.5-flash-native-audio-preview-09-2025")
